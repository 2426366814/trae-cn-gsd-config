...
<!-- For checkpoint task examples and patterns, see @$GSD_DIR/references/checkpoints.md -->
...
See `$GSD_DIR/references/tdd.md` for TDD plan structure.
...
See `$GSD_DIR/templates/user-setup.md` for full schema and examples
...
See `$GSD_DIR/workflows/verify-phase.md` for verification logic.
