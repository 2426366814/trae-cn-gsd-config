...
const MODEL_PROFILES = {
  ...
  // Additional agents (added for completeness)
  'gsd-advisor-researcher': { quality: 'opus', balanced: 'sonnet', budget: 'haiku' },
  'gsd-assumptions-analyzer': { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku' },
  'gsd-user-profiler': { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku' },
};
