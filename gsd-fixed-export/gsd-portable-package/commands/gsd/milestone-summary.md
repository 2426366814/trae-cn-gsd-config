...
<execution_context>
@$HOME/.trae-cn/get-shit-done/workflows/milestone-summary.md
</execution_context>
...
**User input:**
- Version: $ARGUMENTS (optional â€?defaults to current/latest milestone)
</context>

<process>
Read and execute the milestone-summary workflow from @$HOME/.trae-cn/get-shit-done/workflows/milestone-summary.md end-to-end.
</process>
