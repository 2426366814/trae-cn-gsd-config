...
type: prompt
name: gsd:forensics
description: Post-mortem investigation for failed GSD workflows â€?analyzes git history, artifacts, and state to diagnose what went wrong
...
<execution_context>
@$HOME/.trae-cn/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @$HOME/.trae-cn/get-shit-done/workflows/forensics.md end-to-end.
</process>
