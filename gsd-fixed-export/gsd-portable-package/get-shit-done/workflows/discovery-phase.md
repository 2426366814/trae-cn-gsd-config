...
See $GSD_DIR/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using $GSD_DIR/templates/discovery.md structure:
...
1. **Scope the discovery** using $GSD_DIR/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from $GSD_DIR/templates/discovery.md
...
Use $GSD_DIR/templates/discovery.md.
