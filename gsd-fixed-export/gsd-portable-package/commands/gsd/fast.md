---
name: gsd:fast
description: Execute a trivial task inline â€?no subagents, no planning overhead
...
This is NOT a replacement for /gsd:quick â€?use /gsd:quick for anything that
