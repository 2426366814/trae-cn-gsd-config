...
Use template: $HOME/.trae-cn/get-shit-done/templates/research-project/SUMMARY.md
...
```bash
node "$HOME/.trae-cn/get-shit-done/bin/gsd-tools.cjs" commit "docs: complete project research" --files .planning/research/
```
