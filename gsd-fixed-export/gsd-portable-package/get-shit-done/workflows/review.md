...
�?Reviewing with {CLI}... done �?�?Reviewing with {CLI}... done �?```
</step>
...
Commit:
```bash
node "$GSD_BIN/gsd-tools.cjs" commit "docs: cross-AI review for phase {N}" --files {phase_dir}/{padded_phase}-REVIEWS.md
```
</step>
