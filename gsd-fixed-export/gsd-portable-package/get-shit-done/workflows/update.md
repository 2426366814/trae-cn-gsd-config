...
global: `$CONFIG_DIR/`, `~/.config/opencode/`, `~/.opencode/`, `~/.gemini/`, or `~/.codex/`
local: `./.claude/`, `./.config/opencode/`, `./.opencode/`, `./.gemini/`, or `./.codex/`)

Your custom files in other locations are preserved:
- Custom commands not in `commands/gsd/` �?- Custom agents not prefixed with `gsd-` �?- Custom hooks �?- Your CLAUDE.md files �?
